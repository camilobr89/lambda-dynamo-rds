...
exports.insertOrUpdateDisbursement = void 0;
const promise_1 = __importDefault(require("mysql2/promise"));
const config_1 = require("../config");
let pool;
const getPool = () => {
    if (!pool) {
        pool = promise_1.default.createPool(config_1.dbConfig);
    }
    return pool;
};
const insertOrUpdateDisbursement = async (disbursement) => {
...
exports.insertOrUpdateDisbursement = insertOrUpdateDisbursement;
